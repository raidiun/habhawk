...
class UploaderThread(threading.Thread):
    ...
    def caught_exception(self):
        ...
        self.warning("Caught " + oneline())
		#Line modified to reflect local definition of oneline. Original:
...
#	github.com/ukhas/habitat/tree/develop/habitat/utils/quick_traceback.py
# to avoid .utils import on line 42, Only other edit at line 410-2
####################################################################
